...
class ColorLanguageServer(LanguageServer):

    @LanguageServer.feature(
        types.TEXT_DOCUMENT_DOCUMENT_COLOR,
    )
    def document_color(self, params: types.CodeActionParams):
    ...
    def color_presentation(self, params: types.ColorPresentationParams):
...
server = ColorLanguageServer("color-server", "v1")
